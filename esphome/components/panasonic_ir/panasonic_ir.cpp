...
void PanasonicClimate::set_vertical_vane_select(template_::TemplateSelect *vertical_vane_select) {
...
void PanasonicClimate::set_horizontal_vane_select(template_::TemplateSelect *horizontal_vane_select) {
